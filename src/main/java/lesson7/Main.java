...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        allCats[1] = new Cat("Снежок", 20, false);
        allCats[2] = new Cat("Мурзик", 50, false);
        ...
        for (int i = 0; i < allCats.length; i++) {
            if (allCats[i].fullness == false && allCats[i].appetite < plate.food){
                ...
                System.out.println("Котик " + allCats[i].name + " прибежал обедать!");
            } else {
                System.out.println("Котик " + allCats[i].name + " не голодный");
            }
        }
        plate.info();
